          ...
          <>
            <div className="flex flex-col gap-2 h-full">
              ...
              <div className="bg-(--color-base-100) rounded-lg p-3">
                <div className="flex justify-between items-center border-b border-(--color-secondary) pb-2 mb-2.5">
                  ...
                  {restaurantFormData.socialMediaLinks.map((link, index) => (
                    ...
                    >
                      <input
                        ...
                        className={`w-full px-1.5  border border-(--color-secondary) ${editingRestaurant ? "bg-white" : "bg-(--color-base-100)"} rounded text-sm`}
                        disabled={!editingRestaurant}
                      />
