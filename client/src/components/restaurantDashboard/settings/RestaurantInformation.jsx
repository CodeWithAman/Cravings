                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="w-full ">
                    ...
                    <input
                      ...
                      className={`w-full px-1.5 border border-(--color-secondary) ${editingProfile ? "bg-white" : "bg-(--color-base-100)"} rounded`}
                  ...
                  <div className="w-full">
                    ...
                    <input
                      ...
                      onChange={handleProfileChange}
                      className={`w-full px-1.5 border border-(--color-secondary) disabled:bg-(--color-base-100) cursor-not-allowed  rounded`}
                      disabled
                    />
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2 justify-center items-center">
              <div className="w-full">
                ...
                <input
                  ...
                  className={`w-full px-1.5 border border-(--color-secondary) ${editingRestaurant ? "bg-white" : "bg-(--color-base-100)"} rounded`}
              ...
              <div className="w-full col-span-1 md:col-span-3">
                ...
                <textarea
                  ...
                  onChange={handleRestaurantChange}
                  rows={2}
                  className={`w-full px-1.5 border border-(--color-secondary) ${editingRestaurant ? "bg-white" : "bg-(--color-base-100)"} rounded resize-none`}
                  disabled={!editingRestaurant}
                />
              </div>
            </div>
