          ...
          <div className="relative max-w-5xl mx-auto flex flex-col sm:flex-row items-center gap-5">
            ...
            <div className="flex gap-3 shrink-0">
              {[
                ...
                <div
                  key={s.label}
                  className="bg-white/20 backdrop-blur-sm rounded-2xl px-4 py-2.5 text-center text-white w-16"
                >
          ...
          <div className="flex flex-col lg:flex-row gap-5 items-start">
            ...
            <div className="w-full lg:w-56 shrink-0 flex flex-col gap-4">
              ...
              <div className="bg-gray-800/90 backdrop-blur-md rounded-2xl p-4 flex flex-col gap-3">
                ...
                <button className="mt-1 w-full flex items-center justify-center gap-1.5 btn-shimmer text-white text-xs font-bold py-2.5 rounded-xl hover:opacity-90 transition">
            ...
            <div className="flex-1 min-w-0 flex flex-col gap-5">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                ...
                <Link
                  to="/products"
                  className="shrink-0 btn-shimmer text-white font-bold px-5 py-2.5 rounded-xl hover:opacity-90 transition text-sm"
                >
                  Order Now
                </Link>
              </div>
              ...
              <div className="bg-gray-800/90 backdrop-blur-md rounded-2xl p-5">
                ...
                <div className="grid grid-cols-6 gap-3">
                  {quickActions.map((action) => (
                    ...
                    >
                      <div
                        className={`w-11 h-11 rounded-2xl bg-linear-to-br ${action.bg} flex items-center justify-center text-white shadow group-hover:scale-110 transition duration-300`}
                      >
                        {action.icon}
                      </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-5">
                ...
                <div className="flex flex-col items-center justify-center py-8 text-center">
                  ...
                  <Link
                    to="/products"
                    className="mt-4 btn-shimmer text-white text-sm font-bold px-5 py-2 rounded-xl hover:opacity-90 transition"
                  >
                    Order Now
                  </Link>
                </div>
              ...
              {/* Promo */}
              <div className="btn-shimmer rounded-2xl p-5 flex flex-col sm:flex-row items-center justify-between gap-4">
